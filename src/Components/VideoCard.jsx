  ...
  return (
    <>
      <Card draggable onDragStart={e => dragStarted(e, video?.id)}>
        <Card.Img height={'250px'} onClick={handleShow} variant="top" src={video?.url} />
        <Card.Body>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <iframe className='w-100' height="387" src={`${video?.link}?autoplay=1`} title={video?.caption} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </Modal.Body>
      </Modal>
